...
namespace St
{
    public class Building
    {
        ...
        public static readonly Building PowerPlantI =
            new Building(nameof(PowerPlantI),
                Turn.s(200),
                new[] { Energy.Points(2) },
                new Quantity[0], 
                Mineral.Points(-60));
        public static readonly Building BasicMine =
            new Building(nameof(BasicMine), 
                Turn.s(120), 
        ...
        public static readonly Building BasicScienceLab = 
            ...
            new []{Energy.Points(-1)}, 
            Mineral.Points(-60));
        public static readonly Building UplinkNode =
            new Building(nameof(UplinkNode),
                Turn.s(172),
                new[] { Unity.Points(2) },
                new[] { Energy.Points(-1) },
                Mineral.Points(-100));

        public static readonly IEnumerable<Building> BasicBuildings = new[] {PowerPlantI, BasicMine, BasicScienceLab, UplinkNode};
        ...
        private Building(string name, Quantity buildTime, Quantity[] produce, Quantity[] maintenance, params Quantity[] cost)
        {
            _name = name;
